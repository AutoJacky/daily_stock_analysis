...
class Config:
    ...
    push_report_self_heal_max_attempts: int = 4  # 单股/大盘当次运行最多自愈轮数
    ...
    market_review_strict_data_only: bool = False  # 仅用结构化行情生成大盘复盘，禁止 LLM 扩写事实
    ...
    def _load_from_env(cls) -> 'Config':
        ...
        return cls(
            ...
            market_review_strict_data_only=os.getenv(
                'MARKET_REVIEW_STRICT_DATA_ONLY',
                'false',
            ).lower() == 'true',
